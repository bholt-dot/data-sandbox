...
DepartResult depart(const Content& content, World& world, ShipId ship_id, StationId destination,
    ...
    // TODO(finance): also require finance::can_depart(world, ship_id) (docking fees owed) and
    // report CourseStatus::dock_fees_owed; finance.hpp lands with the finance bean.
